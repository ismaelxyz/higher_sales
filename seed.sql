...
-- CREATE DATABASE IF NOT EXISTS higher_sales_production;
-- CREATE DATABASE IF NOT EXISTS higher_sales_production_cache;
-- CREATE DATABASE IF NOT EXISTS higher_sales_production_queue;
-- CREATE DATABASE IF NOT EXISTS higher_sales_production_cable;

-- Use the main production database for the seed data
-- USE higher_sales_production;
