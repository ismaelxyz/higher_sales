...
# specs to be run twice. It is recommended that you do not name files matching
# this glob to end with _spec.rb. You can configure this pattern with the
# --pattern option on the command line or in ~/.rspec, .rspec or `.rspec-local`.
#
